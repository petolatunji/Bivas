  ...
  return (
    <div className='mx-auto'>
      <div className='flex  md:flex justify-center items-center h-screen grid-cols-2 max-w-[1240px] m-auto'>
        <div className='md:bg-[#002c3e] text-white flex flex-col  items-center basis-2/4 h-[65%]  '>
          <h1 className='mt-40 mb-5 text-2xl font-bold'>Come Join us!</h1>
          <p className='w-2/3 text-center text-base'>
            We are excited to have you here. if you haven't already, create an
            account to get access to exclusive offers, rewards, and discounts.
          </p>
          <button className='md:flex gap-2 mb-40 mt-10 p-3'>
            <p>
              <Link
                to='/login'
                style={{
